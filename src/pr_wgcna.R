...
type.exp <- c("raw", "rin", "quarterpc", "halfpc", "pc")
  ...
  png(paste(plot.dir, "/PR/wgcna_networks_", tiss, ".png", sep = ""), height = 2, width = 4, units = "in", res = 400)
  print(fig_pr)
  dev.off()

  ## save file
  saveRds(pr.plot, file = paste(res.dir, "/PR/pr_density_wgcna_", tiss, ".Rds", sep = "" ))
