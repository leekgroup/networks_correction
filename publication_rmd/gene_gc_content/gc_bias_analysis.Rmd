...
load(raw.data)
gene_gc <- read.delim("/work-zfs/abattle4/parsana/networks_correction/publication_rmd/gene_gc_content/analysis/gene_full_gc_content.txt", header = F, stringsAsFactors = F)
...
save(gc.coeff, file = "/work-zfs/abattle4/parsana/networks_correction/publication_rmd/gene_gc_content/analysis/gc_estimate_sample.RData")
...
save(gtex.rse.pcs, file = "/work-zfs/abattle4/parsana/networks_correction/publication_rmd/gene_gc_content/analysis/pcs_removed.RData") # save the loadings as RData object
