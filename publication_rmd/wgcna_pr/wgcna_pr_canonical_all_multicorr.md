---
title: "Precision and recall in WGCNA networks using canonical pathway databases with multiple known covariates as predictors"
output:
  html_document:
    code_folding: hide
---
...
plot.thyroid <- plot.thyroid[-which(plot.thyroid$type %in% c("RIN","expeff", "gene GC%", "exonic rate", "multi3")),]
...
plot.muscle <- plot.muscle[-which(plot.muscle$type %in% c("RIN","expeff", "gene GC%", "exonic rate", "multi3")),]
...
plot.lung <- plot.lung[-which(plot.lung$type %in% c("RIN","expeff", "gene GC%", "exonic rate", "multi3")),]
...
plot.blood <- plot.blood[-which(plot.blood$type %in% c("RIN","expeff", "gene GC%", "exonic rate", "multi3")),]
...
plot.sub <- plot.sub[-which(plot.sub$type %in% c("RIN","expeff", "gene GC%", "exonic rate", "multi3")),]
