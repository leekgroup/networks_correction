---
title: "Precision and recall in WGCNA networks using canonical pathway databases with GC bias as the known covariate"
output:
  html_document:
    code_folding: hide
---
...
This script generates panels for supplementary figure 5 in the manuscript titled -- "Addressing confounding artifacts in reconstruction of gene co-expression networks".
This will re-generate precision and recall plots in WGCNA networks using canonical pathway databases and includes GC bias as the known covariate
