...
plot.thyroid <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_wgcna_tft_thyroid.Rds")
...
plot.lung <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_wgcna_tft_lung.Rds")
...
plot.subcutaneous <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_wgcna_tft_subcutaneous.Rds")
...
plot.muscle <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_wgcna_tft_muscle.Rds")
...
plot.blood <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_wgcna_tft_blood.Rds")
...
supp_fig9 <- plot_grid(plot.subcutaneous + xlim(0,0.16) + ylim(0, 0.35) + theme(legend.position="none"),
