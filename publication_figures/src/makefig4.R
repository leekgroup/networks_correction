...
plot.thyroid <- ggplot(plot.thyroid, aes(x = cutheights, y = density, colour = type)) + geom_point(size = 0.3) +
  xlab("cut-heights") + ylab("# of edges")+ggtitle("Thyroid")+ scale_color_manual(values = c("#B22222", "#006400", "#FFA500", "#800080"))
...
plot.lung <- ggplot(plot.lung, aes(x = cutheights, y = density, colour = type)) + geom_point(size = 0.3) +
  xlab("cut-heights") + ylab("# of edges")+ggtitle("Lung")+ scale_color_manual(values = c("#B22222", "#006400", "#FFA500", "#800080"))
...
plot.blood <- ggplot(plot.blood, aes(x = cutheights, y = density, colour = type)) + geom_point(size = 0.3) +
  xlab("cut-heights") + ylab("# of edges")+ggtitle("Whole Blood")+ scale_color_manual(values = c("#B22222", "#006400", "#FFA500", "#800080"))
...
plot.thyroid <- ggplot(plot.thyroid, aes(x = lambda, y = density, colour = type)) + geom_point(size = 0.3) +
  xlab("Penalty") + ylab("# of edges")+ggtitle("Thyroid")+ scale_color_manual(values = c("#B22222", "#006400", "#FFA500", "#800080"))
...
plot.lung <- ggplot(plot.lung, aes(x = lambda, y = density, colour = type)) + geom_point(size = 0.3) +
  xlab("Penalty") + ylab("# of edges")+ggtitle("Lung")+ scale_color_manual(values = c("#B22222", "#006400", "#FFA500", "#800080"))
...
plot.blood <- ggplot(plot.blood, aes(x = lambda, y = density, colour = type)) + geom_point(size = 0.3) +
  xlab("Penalty") + ylab("# of edges")+ggtitle("Whole Blood")+ scale_color_manual(values = c("#B22222", "#006400", "#FFA500", "#800080"))
...
pdf("/work-zfs/abattle4/parsana/networks_correction/publication_figures/fig4.pdf", height = 4.5, width = 7.2)
print(fig4)
dev.off()
