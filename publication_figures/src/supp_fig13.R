...
plot.thyroid <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_thyroid.Rds")
...
plot.lung <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_lung.Rds")
...
plot.blood <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_blood.Rds")
...
plot.skin <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_skin.Rds")
...
plot.muscle <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_muscle.Rds")
...
plot.subcutaneous <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_subcutaneous.Rds")
...
plot.artery <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_artery.Rds")
...
plot.nerve <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_shared_nerve.Rds")
...
pdf("/work-zfs/abattle4/parsana/networks_correction/publication_figures/suppfig13.pdf", height = 6.5, width = 7.2)
print(fig2)
dev.off()
