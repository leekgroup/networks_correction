...
plot.thyroid <- ggplot(plot.thyroid, aes(x = power, y = 1-precision, colour = type)) + geom_point(size =0.3) +
  xlab("power") + ylab("FDR")+ggtitle("Thyroid") + scale_color_manual(values = c("#B22222", "#006400", "#800080"))
...
plot.lung <- ggplot(plot.lung, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("Lung")+ scale_color_manual(values = c("#B22222", "#006400", "#800080"))
...
plot.blood <- ggplot(plot.blood, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("Whole Blood")+ scale_color_manual(values = c("#B22222", "#006400","#800080"))
...
plot.skin <- ggplot(plot.skin, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("skin")+ scale_color_manual(values = c("#B22222", "#006400", "#800080"))
...
plot.muscle <- ggplot(plot.muscle, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("muscle")+ scale_color_manual(values = c("#B22222", "#006400", "#800080"))
...
plot.subcutaneous <- ggplot(plot.subcutaneous, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("subcutaneous")+ scale_color_manual(values = c("#B22222", "#006400", "#800080"))
...
plot.artery <- ggplot(plot.artery, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("artery")+ scale_color_manual(values = c("#B22222", "#006400", "#800080"))
...
plot.nerve <- ggplot(plot.nerve, aes(x = power, y = 1-precision, colour = type)) + geom_point(size = 0.3) +
  xlab("power") + ylab("FDR")+ggtitle("nerve")+ scale_color_manual(values = c("#B22222", "#006400", "#800080"))
###############################
...
pdf("/work-zfs/abattle4/parsana/networks_correction/publication_figures/suppfig15.pdf", height = 6.5, width = 7.2)
print(fig2)
dev.off()
