...
fig2 <- plot_grid(plot.muscle + xlim(0.9,1.0) + ylim(0.5, 1) + theme(legend.position="none"),
...
pdf("/work-zfs/abattle4/parsana/networks_correction/publication_figures/suppfig1.pdf", height = 4.5, width = 7.2)
print(fig2)
dev.off()
