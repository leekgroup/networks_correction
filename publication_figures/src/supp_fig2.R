...
fig2 <- plot_grid(plot.muscle + xlim(0.3,1.0) + ylim(0, 1) + theme(legend.position="none"),
...
pdf("/work-zfs/abattle4/parsana/networks_correction/publication_figures/suppfig2.pdf", height = 4.5, width = 7.2)
print(fig2)
dev.off()