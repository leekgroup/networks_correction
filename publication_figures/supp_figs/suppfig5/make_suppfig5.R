...
supp_fig2 <- plot_grid(plot.sub + xlim(0,0.15) + ylim(0, 0.35) + theme(legend.position="none"),
	plot.thyroid + xlim(0,0.15) + ylim(0, 0.35) +  theme(legend.position="none"),
	plot.lung + xlim(0,0.15) + ylim(0, 0.35) + theme(legend.position="none"),
	plot.muscle + xlim(0,0.15) + ylim(0, 0.35) + theme(legend.position="none"),
	plot.blood + xlim(0,0.15) + ylim(0, 0.35) + theme(legend.position="none"),
	legend,
#	align = 'vh',
           labels = c("a", "b", "c", "d", "e", ""),
           hjust = -1,
...
pdf("supp_fig5.pdf", height = 7.2, width = 7.2)
print(supp_fig2)
dev.off()
