...
plot.thyroid <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_networks_tft_thyroid.Rds")
...
plot.lung <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_networks_tft_lung.Rds")
...
plot.subcutaneous <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_networks_tft_subcutaneous.Rds")
...
plot.muscle <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_networks_tft_muscle.Rds")
...
plot.blood <- readRDS("/work-zfs/abattle4/parsana/networks_correction/results/PR/pr_density_glasso_networks_tft_blood.Rds")
...
supp_fig9 <- plot_grid(plot.subcutaneous + xlim(0,0.015) + ylim(0, 0.9) + theme(legend.position="none"),
	...
	plot.muscle + xlim(0,0.015) + ylim(0, 0.9) + theme(legend.position="none"),
	plot.blood + xlim(0,0.015) + ylim(0, 0.9) + theme(legend.position="none"),
	legend,
#	align = 'vh',
           labels = c("a", "b", "c", "d", "e", ""),
           hjust = -1,
