...
supp_fig8 <- plot_grid(plot.subcutaneous + xlim(0,0.04) + ylim(0, 0.9) + theme(legend.position="none"),
	plot.thyroid + xlim(0,0.04) + ylim(0, 0.9) +  theme(legend.position="none"),
	plot.lung + xlim(0,0.04) + ylim(0, 0.9) + theme(legend.position="none"),
	plot.muscle + xlim(0,0.04) + ylim(0, 0.9) + theme(legend.position="none"),
	plot.blood + xlim(0,0.04) + ylim(0, 0.9) + theme(legend.position="none"),
	legend,
#	align = 'vh',
           labels = c("a", "b", "c", "d", "e", ""),
           hjust = -1,
...
pdf("supp_fig8.pdf", height = 7.2, width = 7.2)
print(supp_fig8)
dev.off()
